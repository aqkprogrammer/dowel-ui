...
const SYNONYMS: Record<string, string[]> = {
  ...
  undo: ["ai-action-ledger", "agent-ledger"],
  ...
  search: ["command", "combobox", "expanding-search", "faq-searchable", "nl-filter"],
  ...
  time: ["time-range-picker", "duration-picker", "countdown"],
  ...
  music: ["now-playing"],
  player: ["now-playing", "step-player"],
  ...
  physics: ["gravity-field", "goo-ball"],
  ...
  todo: ["animated-checklist", "todo-tower"],
  tasks: ["animated-checklist"],
  odometer: ["number-flow"],
  webmcp: ["agent-surface"],
  "browser agent": ["agent-surface", "control-baton"],
  "agent tools": ["agent-surface"],
  "operate the ui": ["agent-surface"],
  "take over": ["control-baton"],
  takeover: ["control-baton"],
  "hand back": ["control-baton"],
  handoff: ["control-baton"],
  "human in the loop": ["control-baton", "ai-approval-request"],
  "screen reader": ["stream-announcer"],
  "read aloud": ["stream-announcer"],
  "live region": ["stream-announcer"],
  announce: ["stream-announcer"],
  "agent approval": ["agent-approvals", "ai-approval-request"],
  "approve with changes": ["agent-approvals", "ai-approval-request"],
  "what the agent did": ["agent-ledger", "ai-action-ledger"],
  autofill: ["agent-form", "ai-suggested-value"],
  "fill form": ["agent-form"],
  ...
  authorship: ["provenance-text"],
  "who wrote this": ["provenance-text"],
  "ai written": ["provenance-text"],
  attribution: ["provenance-text", "ai-sources"],
  provenance: ["provenance-text"],
  "natural language filter": ["nl-filter"],
  "filter bar": ["nl-filter", "data-table"],
  "filter chips": ["nl-filter"],
  "query builder": ["nl-filter", "expression-editor"],
  "smart search": ["nl-filter"],
  "faceted search": ["nl-filter"],
  "assistant memory": ["memory-inspector"],
  "remembered facts": ["memory-inspector"],
  "forget memory": ["memory-inspector"],
  "personal context": ["memory-inspector"],
  formula: ["expression-editor"],
  expression: ["expression-editor"],
  "calculated field": ["expression-editor"],
  "rule editor": ["expression-editor"],
  "unit input": ["quantity-input"],
  measurement: ["quantity-input"],
  "unit converter": ["quantity-input"],
  "number with unit": ["quantity-input"],
  weight: ["quantity-input"],
  consent: ["permission-prompt"],
  "access request": ["permission-prompt"],
  scope: ["permission-prompt"],
  "just in time permission": ["permission-prompt"],
  "allow or deny": ["permission-prompt", "ai-approval-request"],
  sonification: ["chart-sonifier"],
  "audio chart": ["chart-sonifier"],
